...
const SchoolGrowth = () => {
  return (
    <section className='school-growth-section'>
        <div className='main-section'>
            <div className='title-container'>
                <div><h1><span>Join LearnNova's Learning Support </span><span className='break-line'>& School Growth System to Access These Exclusive <span className='bold yellow-text'>Benefits!</span></span></h1></div>
                <div className='title-logo-body'>
            ...
            <div className='text-body-container'>
                ...
                <div className='contact-body'>
                    <h3 className='deep-purple bold'>To Enrol Call:</h3>
