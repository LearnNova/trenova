            ...
            <table className="table-auto border-collapse border border-gray-400 w-full">
                <tbody className="text-lg md:text-xl lg:text-3xl">
                    ...
                    <tr className="bg-gray-100">
                        ...
                        <td className="text-black border border-gray-400 px-4 py-2 font-bold"><span className="text-orange-500">25.6%</span> of the termly subscription fee (₦400k income per month on 50 customers).</td>
                    </tr>
                    <tr>
